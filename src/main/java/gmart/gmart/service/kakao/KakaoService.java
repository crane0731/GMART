package gmart.gmart.service.kakao;
...
public class KakaoService {
    ...
    private final KakaoProperties kakaoProperties; //카카오 설정
    ...
    public TokenResponseDto kakaoLogin(String code){
        ...
        KakaoUserDetail userDetail = getKakaoUserDetail(kakaoToken);
    ...
    private void processSignUp(SignUpRequestDto signUpRequestDto) {
        ...
        memberService.createStore(member);
    }
