...
public class BuyerOrderListResponseDto {
     ...
     * [생성 메서드]
     * @param order 주문 엔티티
     * @return BuyerOrderListResponseDto 응답 DTO
     */
    public static BuyerOrderListResponseDto create(Order order){

        BuyerOrderListResponseDto dto = new BuyerOrderListResponseDto();
